...
with streamlit_analytics.track():
    ...
    st.write("***Principales causas identificadas:***")
    ...
    st.write("***Impacto en la Sociedad: Consecuencias y Desafíos***")
    ...
    st.write("***Iniciativas y Soluciones: Caminos hacia la Mejora***")
